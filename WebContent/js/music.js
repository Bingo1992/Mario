var startMusic,overMusic,playingMusic,dieMusic;
function initMusic(){
	//开场音乐  
...
SoundPlayer.prototype.loadSound = function(){
	...
	self.loadIndex++;
	self.background.addEventListener(LEvent.COMPLETE,self.backgroundLoadComplete);
	self.background.load("./sound/startbg.mp3");
};
